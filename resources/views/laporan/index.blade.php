...
<div class="container">
    <div class="alert alert-secondary" role="alert"> Laporan Pengembalian </div> 
        <div class="row">
            <div class="col">
                    ...
                    <div class="card-body">
                        <form>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <div class="col">
                                    <a class="btn btn-secondary" href="#"> Rekap seluruh Data Buku </a>
                                    </div>
                                
                                <div class="row">
                                    <div class="col">
                                    <a class="btn btn-info" href="#"> Tambah buku </a>
                                    </div>
                                </div>
                            </div>
